...
def main():
    ...
    print('Based on the range of Lambda values tested, the best lambda tested is ' + str(lmda_best) + ', which yields an MSE of ' + str(MSE_best) + 'as shown on the plot above')
