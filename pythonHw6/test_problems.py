...
class TestProblem2(unittest.TestCase):
    def test_simple_valid_streetname(self):
        self.assertEqual(
            problems.problem2('465 Northwestern Ave.'), 'Northwestern',
            'The street name in `465 Northwestern Ave.` is `Northwestern`.')

    def test_simple_valid_streetname(self):
        self.assertEqual(problems.problem2('1 abc St. 1 Abc St.'), 'Abc',
    ...
    def test_multiple_word_streetname(self):
        self.assertEqual(problems.problem2('201 South First St.'),
                         'South First', 'Street names can be multiple words.')

    def test_long_streetname(self):
        self.assertEqual(
            problems.problem2('1 Aa B C D E F St.'), 'Aa B C D E F',
